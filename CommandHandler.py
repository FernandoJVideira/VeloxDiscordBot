...
class CommandHandler(commands.Cog):
    ...
    async def help(self,ctx):
        ...
        ModEmbed.add_field(name = "!!edit region", value = "Edit's the server Region!", inline = False)
        ModEmbed.add_field(name = "!!edit createrole", value = "Creates a Role in the Server!", inline = False)
        ModEmbed.add_field(name = "!!edit createtextchannel/createvoicechannel", value = "Creates a Text/Voice Channel in the Server", inline = False)
